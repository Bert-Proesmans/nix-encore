...
#
# Code ripped from https://github.com/nushell/nushell/issues/10610#issuecomment-3454791011
# Exporting main makes the symbol name of the file available to the caller.
# Example usage;
#		use ./psub.nu
#		cmp (psub { 0x[00 00] }) (psub { 0x[00 01] })
export def main [
